...
import br.com.yaw.ssjpac.service.MercadoriaService;
...
/**
 * Define a
 * <code>Controller</code> principal do sistema, responsável por gerir a tela com a lista de
 * <code>Mercadoria</code>.
 *
 * <p>
 * <code>ListaMercadoriaController</code> é mapeada como
 * <code>@Component</code> do Spring. Dessa forma uma instância de <code>ListaMercadoriaController</code> pode ser criada e gerenciada pelo Spring, favorecendo
 * a Inversão de Controle <i>(IoC)</i> e Injeção de Dependência <i>(DI)</i>.
 * </p>
 *
 * <p>
...
//    @Autowired
//    private IncluirMercadoriaController incluirController2;
////    @Autowired
//    private BuscarMercadoriaController buscarController_;
    @Autowired
    private BuscarMercadoriaTesteController buscarController;
    @Autowired
    ...
    private void refreshTable() {
        List<Mercadoria> findAll = this.mercadoriaService.findAll();

        this.frame.refreshTable(findAll);
    }
}
