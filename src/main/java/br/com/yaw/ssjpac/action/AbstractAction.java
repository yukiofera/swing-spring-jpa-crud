...
/**
 * Componente representa uma ação, normalmente vinculada a intervenção do usuário nos componentes de interface gráfica, para solicitar uma operação ao sistema.
 *
 * <p>
 * A ação é representada por
 * <code>AbstractAction</code>, um tipo de componente complementar ao
 * <code>MVC</code> (<strong>M</strong>odel <strong>V</strong>iew <strong>C</strong>ontroller), um modelo arquitetural utilizado para organizar os componentes
 * do sistema.
 * </p>
 *
 * <p>
 * Utiliza o design pattern
 * <code>Template Method</code> para definir um estrutura/template com código complementar (e opcional) a ação:
 * </p>
 *
 * <ul>
