...
/**
 * Contrato de persistência para a entidade
 ...
 *
 * <p>
 * As operações básicas do cadastro são definidas indiretamente pela interface pai,
 * <code>JpaRepository</code>. O Spring Data JPA gera a classe (proxy) que implementa essa interface. Dessa forma métodos especificos do cadastro, como
...
public interface MercadoriaDAO extends JpaRepository<Mercadoria, Integer> {
    ...
    /**
     * Utiliza anotação
     * <code>Query</code> do Spring Data JPA pra definir o código SQL.
     *
