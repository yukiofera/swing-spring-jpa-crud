...
/**
 * Tela para incluir/editar o registro da
 * <code>Mercadoria</code>.
 *
 * <p>
 * Essa tela trabalha em modo inclusão ou edição de
 * <code>Mercadoria</code>. Em edição é possível acionar a funcionalidade para remover
 * <code>Mercadoria</code>.
 * </p>
 *
 * <p>
 * <code>IncluirMercadoriaFrame</code> é mapeada como
 * <code>@Component</code> do Spring. Dessa forma uma instância de <code>IncluirMercadoriaFrame</code> pode ser criada e gerenciada pelo Spring, favorecendo a
 * Inversão de Controle <i>(IoC)</i> e Injeção de Dependência <i>(DI)</i>.
 * </p>
 *
